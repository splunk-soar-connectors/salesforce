...
SALESFORCE_UNICODE_DAMMIT_TYPE_ERROR_MSG = "Error occurred while connecting to the Salesforce server. Please check the asset configuration and|or the action parameters."
